...
public class FacePlayerSystem : ComponentSystem
{
    ...
    protected override void OnUpdate()
    {
        ...
        /*Entities.WithAll<BulletTag>().ForEach((Entity entity,ref Translation trans, ref Rotation rot) =>
        {
            BulletTag bulletTag = entity.;
            if (bulletTag.aimed == false)
            {
                //calculate vectors
